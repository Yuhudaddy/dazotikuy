...
const zh = {
  ...
  model3dButtons: "右上角選單：重置視角、定位樓層、輸入座標、外牆透明、全圖總覽與全螢幕",
  model3dOverviewLabel: "全圖總覽",
  model3dResetLabel: "重置視角",
  model3dPickInfo: "點擊模型可放置圖釘，顯示該處名稱與 BOM 座標",
  ...
  model3dGoLabel: "前往",
  model3dCoordsLabel: "輸入座標",
  model3dCoordsField: "BOM 座標 x, y, z（y 留空自動貼地）",
  model3dCoordsPlaceholder: "-4200, 300, -2700",
  model3dCoordsInvalid: "格式不對，請輸入 x, y, z 或 x, z",
  model3dCoordsNoSurface: "這個位置沒有地表，請確認座標",
  model3dPinLabel: "選取位置",
...
const ja: Record<keyof typeof zh, string> = {
  ...
  model3dButtons: "右上のメニュー：視点リセット、フロアへ移動、座標を入力、外壁の透過、マップ全体、全画面表示",
  model3dOverviewLabel: "マップ全体",
  model3dResetLabel: "視点をリセット",
  model3dPickInfo: "モデルをクリックするとピンを置き、その場所の名前と BOM 座標を表示します",
  ...
  model3dGoLabel: "移動",
  model3dCoordsLabel: "座標を入力",
  model3dCoordsField: "BOM 座標 x, y, z（y 省略で地表に合わせる）",
  model3dCoordsPlaceholder: "-4200, 300, -2700",
  model3dCoordsInvalid: "形式が正しくありません。x, y, z または x, z を入力してください",
  model3dCoordsNoSurface: "この位置には地表がありません。座標を確認してください",
  model3dPinLabel: "選択した位置",

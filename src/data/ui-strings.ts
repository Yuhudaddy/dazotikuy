...
const zh = {
  ...
  model3dResetHint: "北方朝上",
  model3dFloorsLabel: "定位樓層",
  model3dSelectFloor: "選擇關卡樓層",
  model3dGoLabel: "前往",
  model3dCoordsLabel: "輸入座標",
  model3dCoordsField: "BOM 座標（y 留空自動貼地）",
  model3dCoordsInvalid: "請輸入數字",
...
const ja: Record<keyof typeof zh, string> = {
  ...
  model3dResetHint: "北を上に",
  model3dFloorsLabel: "フロアへ移動",
  model3dSelectFloor: "フロアを選択",
  model3dGoLabel: "移動",
  model3dCoordsLabel: "座標を入力",
  model3dCoordsField: "BOM 座標（y 省略で地表に合わせる）",
  model3dCoordsInvalid: "数値を入力してください",
